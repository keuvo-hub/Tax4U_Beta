...
const assignedEmailUserAndAC = async (data = {}) => {
                    ...
                    <div style="margin: auto; width: 600px; padding-top: 50px;">
                        <div
                            ...
                            <div style="border-radius: 5px; background-color: rgba(0,0,0, .1); padding: 10px; margin: 30px 0px;">
                                <h4>
                                    Thanks for submitting your tax file. We have already assigned an accountant for your application.
                                </h4>
                            </div>
...
module.exports = assignedEmailUserAndAC;