...
const finalEmailToAdminsAndAC = async (data = {}) => {
    ...
    const info = await transporter.sendMail({
        from: email_from,
        to: `${data.assigned_accountant.email}, ${envFileData?.admins_email_list}`,
                    ...
                    <div style="margin: auto; width: 50%; padding-top: 50px;">
                        <div
                            ...
                            <div style="border-radius: 5px; background-color: rgba(0,0,0, .1); padding: 10px; margin: 30px 0px;">
                                <h4>
                                Tax file ID: ${data.ID}, Phone number: ${data.phone_number}, <br> Username: ${data.user.username}, and Email: ${data.user.email} <br> <br> His/her work has completed and a file has sent successfully.
                                </h4>
                            </div>
...
module.exports = finalEmailToAdminsAndAC;